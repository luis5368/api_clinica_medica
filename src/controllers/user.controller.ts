...
export const getUsers = async (req: AuthRequest, res: Response) => {
  try {
    ...
    // Superadmin ve todos los usuarios creados por él o admins que creó
    ...
    // Admin ve solo los usuarios creados por él
    ...
    // Medico y enfermero solo se ven a sí mismos
    if (currentUser.role === 'medico' || currentUser.role === 'enfermero' || currentUser.role === 'recepcionista') {
      const result = await pool.request()
